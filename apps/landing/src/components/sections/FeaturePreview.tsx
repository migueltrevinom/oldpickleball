        ...
        <div className="space-y-12">
          {previews.map((feature, i) => (
            ...
            >
              ...
              <div
                className={`relative flex-1 w-full aspect-[4/3] md:aspect-auto md:min-h-[340px] overflow-hidden rounded-[2rem] bg-gradient-to-br ${feature.bgColor} p-6 shadow-[0_28px_70px_rgba(16,24,40,0.13)]`}
              >
                <div className="court-grid absolute inset-0 opacity-20" />
                <div className="relative h-full rounded-[1.5rem] border border-white/50 bg-white/75 p-5 shadow-xl backdrop-blur">
